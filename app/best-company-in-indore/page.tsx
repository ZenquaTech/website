import heroImageIcon from "@/public/images/best-it-company-in-indore.webp"
import Image from "next/image";
export default function BestCompanyInIndore() {
    return (
        <div style={{ fontFamily: "Arial, sans-serif", lineHeight: "1.6", margin: "100px", padding: "0" }}>
          ...
          <header style={{ backgroundColor: "black", color: "white", padding: "20px 10px", textAlign: "center" }}>
            <h1 style={{fontSize:"35px"}}>Welcome to the Best Company in Indore</h1>
