...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    metadataBase,
    title: "Welcome to the  it  Company in Indore | ZenQua Technologies Pvt Ltd",
    ...
    keywords:
      "It company in indore,Contact ZenQua, ZenQua Contact Form, Contact ZenQua Technologies, Software Development Services, IT Consultation Form, Mobile App Development Inquiry, Web Development Services, Customized Development Services, Cloud Services Consultation, Software Project Quote, Contact Software Experts, IT Services Form, Software Solutions Inquiry, Budget for IT Project, Project-Based Engagement, Dedicated Team Services, Immediate Software Consultation, Software Project Form, Get in Touch with ZenQua, IT Support Contact, Social Media Links ZenQua,firebase expert,redis development services,redis solutions,firebase development company,firebase development services,vuejs services,nopcommerce development services, ZenQua Address, ZenQua Support Hours, Send Message to ZenQua, IT Services Company Contact",
    icons: {
