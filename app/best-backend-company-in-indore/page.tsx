import heroImageIcon from "@/public/images/best-backend-company.webp"
import Image from "next/image";
export default function BestbackendInIndore() {
    return (
        <div style={{ fontFamily: "Arial, sans-serif", lineHeight: "1.6", margin: "100px", padding: "0" }}>
          {/* Hero Section */}
          <div>
            <Image src={heroImageIcon} alt="best-it-company-in-indore"/>
          </div>
          <header style={{ backgroundColor: "black", color: "white", padding: "20px 10px", textAlign: "center" }}>
            <h1 style={{fontSize:"35px"}}>Welcome to the Best backend Company in Indore</h1>
