...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords:
      "Video content, business insights, technology solutions, software development, software outsourcing, digital transformation, mobile app development, enterprise mobility, thought leadership, IT events, life at ZenQua, IT careers, innovative tech solutions, explore tech topics, actionable insights through videos.",
    icons: {
