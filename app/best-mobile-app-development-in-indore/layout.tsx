...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    metadataBase,
    title: "Welcome to the best Mobile App Development in Indore | ZenQua Technologies Pvt Ltd",
