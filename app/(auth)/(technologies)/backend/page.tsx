              ...
              <Grid container spacing={3}>
                <Grid item xs={12} md={6} className="m-[10px] font-bold">
                  ...
                  <input
                    ...
                    className="input input-bordered w-full bg-gray-900 text-white focus:bg-gray-800 focus:border-[#2090a4]"
                  />
                </Grid>
                <Grid item xs={12} md={6} className="m-[10px] font-bold">
                ...
                <Grid item xs={12} md={6} className="m-[10px] font-bold">
                  ...
                  <select className="select select-bordered w-full bg-gray-900 text-white focus:bg-gray-800 focus:border-[#2090a4]">
                ...
                <Grid item xs={12} className="m-[10px] font-bold">
                  ...
                  <textarea className="textarea input input-bordered w-full bg-gray-900 text-white focus:bg-gray-800 h-36 focus:border-[#2090a4]" placeholder="About project"></textarea>
                </Grid>
                <Grid item xs={12}>
