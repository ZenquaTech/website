  ...
  return (
    <section>
      <div
        ...
        // className="max-w-container relative mx-auto mt-20 w-full px-4 sm:px-6 lg:px-8"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-justify hyphens-auto">
          <div className="bg-transparent pt-8 pr-8 pb-8 flex flex-col text-left">
            ...
            <p className="text-[#9BA9B4] text-lg my-2 text-justify">
              ...
              for cutting-edge digital solutions. With our extensive expertise
              in custom web and mobile app development, we help automate
              businesses, empower agility and optimize digital experiences.
              Unleash the power of digital transformation and build a
              future-proof scaffolding for success.
            </p>
