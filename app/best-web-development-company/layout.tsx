...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    metadataBase,
    title: "Welcome to the best web development Company in Indore | ZenQua Technologies Pvt Ltd",
