          ...
          <div className="grid md:grid-cols-12 gap-8 lg:gap-20 mb-8 md:mb-12">
            ...
            <div className="md:col-span-4 lg:col-span-5">
              <div className="mb-2">
                ...
                <div style={{position:"relative",textAlign:"justify",top:"-22px"}} className="text-sm">
                <ul>
                  <li className="mb-1">
                    <span
                    ...
                    >
                      ...
                      understanding for enlightenment, transcending intellectual
                      study.
                    </span>
                  </li>
                  <li className="mb-1">
                  ...
                  <li className="mb-1">
                    ...
                    >
                      ...
                      The integration of Zen's meditative principles
                      with a defined role or perspective, promoting mindfulness
                      and intuitive clarity within that context.
                    </div>
                  </li>
                </ul>
                </div>
