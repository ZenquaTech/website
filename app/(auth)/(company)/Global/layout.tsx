...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    keywords:
      "IT solutions, engagement models, offshore development, onsite development, customized IT services, technology solutions, digital transformation, project management, software development, agile methodologies, business models, flexible pricing, IT consulting, technology services",
    icons: {
