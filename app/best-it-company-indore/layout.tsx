...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    metadataBase,
    title: "Welcome to the Best it  Company in Indore | ZenQua Technologies Pvt Ltd",
