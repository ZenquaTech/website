import heroImageIcon from "@/public/images/top-10 -company.webp"
import Image from "next/image";
export default function ToptenInIndore() {
    return (
        <div style={{ fontFamily: "Arial, sans-serif", lineHeight: "1.6", margin: "100px", padding: "0" }}>
          ...
          <header style={{ backgroundColor: "black", color: "white", padding: "20px 10px", textAlign: "center" }}>
            <h1 style={{fontSize:"35px"}}>Welcome To Top 10 it Company in Indore</h1>
