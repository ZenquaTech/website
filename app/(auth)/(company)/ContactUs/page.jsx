  ...
  return (
    ...
    <Grid container>
        <Grid item xs={12} sm={4} style={{borderBottom:'1px solid #fff'}} >
            ...
            <Typography style={{color:"#2090a4"}}>+1.404.641.9041</Typography>
            <Typography style={{margin:'2rem',color:"#2090a4"}}>+1.848.313.6176</Typography>
            <Typography>Assistance hours:</Typography>
            <Typography>Monday – Friday</Typography>
            <Typography style={{margin:'2rem'}}>8 am to 6 pm EST</Typography>    
            </Box>
        </Grid>
        ...
        <Typography>110 Fieldcrest Avenue, Office 338,</Typography>
        <Typography>Edison, New Jersey, 08837 </Typography>
        </Box>
        </Grid>
