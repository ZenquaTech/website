...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    metadataBase,
    title: "Welcome to the best front-end Company in Indore | ZenQua Technologies Pvt Ltd",
